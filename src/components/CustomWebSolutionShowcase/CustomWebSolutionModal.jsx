...
import { X, BarChart3, Layout, Rocket, ShieldCheck, Cloud, Activity } from 'lucide-react';

export default function CustomWebSolutionModal({ isOpen, onClose }) {
  ...
  const features = [
    ...
    {
      icon: ShieldCheck,
      title: t('customSolution.feature4Title'),
      desc: t('customSolution.feature4Desc'),
      color: "from-emerald-500 to-teal-600",
      bg: "bg-emerald-50"
    },
    {
      icon: Cloud,
      title: t('customSolution.feature5Title'),
      desc: t('customSolution.feature5Desc'),
      color: "from-amber-500 to-orange-600",
      bg: "bg-amber-50"
    },
    {
      icon: Activity,
      title: t('customSolution.feature6Title'),
      desc: t('customSolution.feature6Desc'),
        ...
        <div className="relative px-6 py-5 sm:px-8 sm:py-6 border-b border-slate-100 flex items-center justify-between bg-gradient-to-r from-slate-50 to-white">
          <div className="pr-10 rtl:pr-0 rtl:pl-10">
            <h3 className="text-xl sm:text-2xl font-black text-slate-900 font-headline-xl">
              {t('customSolution.modalTitle')}
            </h3>
            <p className="text-sm text-slate-500 mt-1">
              {t('customSolution.modalSubtitle')}
            </p>
          </div>
          <button 
            onClick={onClose}
            ...
            aria-label={t('customSolution.closeBtn')}
          >
