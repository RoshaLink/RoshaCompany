...
import { X, TrendingUp, Search, Zap, BarChart3, ShieldCheck, Maximize } from 'lucide-react';
...
export default function FeaturesModal({ isOpen, onClose }) {
  ...
  const features = [
    ...
    {
      icon: BarChart3,
      title: t('salesAndSeo.feature4Title'),
      desc: t('salesAndSeo.feature4Desc'),
      color: "from-indigo-500 to-purple-600",
      bg: "bg-indigo-50"
    },
    {
      icon: ShieldCheck,
      title: t('salesAndSeo.feature5Title'),
      desc: t('salesAndSeo.feature5Desc'),
      color: "from-rose-500 to-red-600",
      bg: "bg-rose-50"
    },
    {
      icon: Maximize,
      title: t('salesAndSeo.feature6Title'),
      desc: t('salesAndSeo.feature6Desc'),
        ...
        <div className="relative px-6 py-5 sm:px-8 sm:py-6 border-b border-slate-100 flex items-center justify-between bg-gradient-to-r from-slate-50 to-white">
          <div className="pr-10 rtl:pr-0 rtl:pl-10">
            <h3 className="text-xl sm:text-2xl font-black text-slate-900 font-headline-xl">
              {t('salesAndSeo.modalTitle')}
            </h3>
            <p className="text-sm text-slate-500 mt-1">
              {t('salesAndSeo.modalSubtitle')}
            </p>
          </div>
          <button 
            onClick={onClose}
            ...
            aria-label={t('salesAndSeo.closeBtn')}
          >
