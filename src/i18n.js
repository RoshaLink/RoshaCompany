  ...
  fa: {
    translation: {
      ...
      brands: {
        ...
        subtitle: "ما بیش از ۲۵۰ ابزار و سرویس آنلاین رو مستقیماً داخل کارهای مهندسیمون استفاده و با هم ترکیب میکنیم.",
      ...
      searchVisibility: {
        ...
        subtitle: "با سرعت خیلی بالا و سئو خودکار دیارا، سایت شما سریع توی گوگل دیده میشه و انتخاب اول مشتریها میشه.",
