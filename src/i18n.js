...
const resources = {
  ...
  fa: {
    translation: {
      ...
      hero: {
        badge: "تحول دیجیتال کسب‌وکار با هوش مصنوعی",
      ...
      brands: {
        badge: "تکنولوژی‌ها و ابزارهای مدرن",
      ...
      searchVisibility: {
        badge: "سئو و دیده شدن در گوگل",
        titlePrefix: "وب‌سایت شما در ",
        titleGradient: "رتبه ۱ گوگل",
        titleSuffix: " قرار می‌گیرد",
        subtitle: "با سرعت فوق‌العاده بالا و سئوی هوشمند دیارا، وب‌سایت شما سریعاً در گوگل دیده شده و به انتخاب اول مشتریان تبدیل می‌شود.",
      ...
      businessAnalysis: {
        ...
        subtitle: "هر کسب‌وکاری ویژگی‌های خاص خود را دارد. ما مدل کاری شما را بررسی کرده، چالش‌ها را شناسایی می‌کنیم و راهکار اختصاصی متناسب با اهداف شما می‌سازیم.",
        bullet1: "تحلیل عمیق مدل کسب‌وکار و مسیر مشتریان",
        bullet2: "توسعه اختصاصی بدون استفاده از قالب‌های آماده",
        bullet3: "خودکارسازی فرآیندها و افزایش ملموس درآمد",
        button: "درخواست مشاوره اختصاصی"
      },
      customSolution: {
        badge: "تحلیل استراتژیک کسب‌وکار و توسعه اختصاصی",
        titlePrefix: "ما کسب‌وکار شما را تحلیل کرده و ",
        ...
        subtitle: "بدون استفاده از قالب‌های آماده. ما اهداف، مخاطبان و فرآیندهای کسب‌وکار شما را بررسی کرده و وب‌سایت یا اپلیکیشن اختصاصی برای رشد و افزایش فروش شما طراحی می‌کنیم.",
        feature1Title: "تحلیل دقیق نیازها و کسب‌وکار",
        feature1Desc: "بررسی کامل مسیر مشتریان و چالش‌های کاری پیش از شروع طراحی.",
        ...
        getStartedBtn: "شروع پروژه اختصاصی",
      ...
      connectWithUs: {
        ...
        langEnDesc: "مشاوره بین‌المللی و توسعه نرم‌افزار برای شرکت‌های جهانی.",
      ...
      salesAndSeo: {
        ...
        subtitle: "ما سرعت فوق‌العاده، طراحی جذب مشتری (CRO) و سئوی پیشرفته گوگل را ترکیب می‌کنیم تا برند شما به بهترین شکل دیده شده و بازدیدکنندگان به مشتری تبدیل شوند.",
        highlight1Title: "افزایش چشمگیر فروش و تبدیل مشتری",
        highlight1Desc: "طراحی مسیرهای هوشمند برای تبدیل بازدیدکنندگان به خریداران واقعی.",
        highlight2Title: "کسب رتبه ۱ در نتایج گوگل",
        highlight2Desc: "حضور در صدر نتایج گوگل با نمایه سریع و سئوی استاندارد.",
        highlight3Title: "سرعت فوق‌العاده و تجربه کاربری بی‌نظیر",
        highlight3Desc: "بارگذاری زیر ۱ ثانیه (امتیاز ۱۰۰ از ۱۰۰) برای جلب رضایت و حفظ مشتریان.",
        boostBtn: "افزایش فروش و سئوی وب‌سایت",
        exploreBtn: "بررسی امکانات"
      },
      mobileApp: {
        badge: "طراحی اپلیکیشن موبایل و انتشار در فروشگاه‌ها",
        titlePrefix: "طراحی اپلیکیشن موبایل و انتشار در ",
        titleGradient: "اپ استور و گوگل پلی",
        titleSuffix: "",
        subtitle: "کسب‌وکار خود را مستقیماً به گوشی همراه مشتریان ببرید. ما اپلیکیشن‌های پرسرعت آیفون (iOS) و اندروید می‌سازیم و تمامی مراحل تایید و انتشار را در اپ استور و گوگل پلی انجام می‌دهیم.",
        feature1Title: "اپلیکیشن‌های پرسرعت iOS و Android",
        feature1Desc: "رابط کاربری روان و پرسرعت با جدیدترین تکنولوژی‌های روز.",
        feature2Title: "انتشار کامل در App Store و Google Play",
        feature2Desc: "انجام کامل مراحل تایید فنی و انتشار رسمی اپلیکیشن شما.",
        feature3Title: "ارسال پیام‌رسان (نوتیفیکیشن) و حالت آفلاین",
        feature3Desc: "ارتباط سریع با مشتریان از طریق اعلانات (Push Notification) و کارکرد بدون اینترنت.",
        buildBtn: "ساخت اپلیکیشن موبایل اختصاصی",
        exploreBtn: "مشاهده جزئیات خدمات"
      },
      whoWeAre: {
        badge: "درباره تیم ما",
        title: "آشنایی با تیم متخصص و ارشد ما",
        subtitle: "ما تیمی از متخصصان ارشد سیستم، طراحان محصول و مهندسان امنیت هستیم که بر ساخت محصولات دیجیتال باکیفیت تمرکز داریم.",
        calloutTitle: "می‌خواهید مستقیماً با مدیران اصلی پروژه همکاری کنید؟",
        calloutSub: "همین امروز یک جلسه مشاوره با مدیران اصلی تیم رزرو کنید.",
        ...
        team: [
          ...
          {
            name: "سام",
            designation: "توسعه‌دهنده ارشد وب",
            quote: "هدف من همیشه ارائه وب‌سایت‌ها و اپلیکیشن‌های پرسرعت، امن و مقیاس‌پذیر است که کیفیتی فراتر از انتظار ارائه دهند."
          },
          {
            name: "مینا",
            designation: "تحلیل‌گر و مشاور کسب‌وکار",
            quote: "با سابقه مشاوره در شرکت‌های مطرح بین‌المللی، تخصص من تحلیل استراتژیک فرآیندها و ایجاد رشد ملموس برای کسب‌وکارهاست."
          },
          {
            name: "میلاد",
            designation: "توسعه‌دهنده ارشد سیستم",
            quote: "تخصص من طراحی زیرساخت‌های مطمئن و رابط‌های کاربری یکپارچه‌ای است که تجربه دیجیتالی فوق‌العاده‌ای برای کاربران می‌سازند."
          }
        ]
      },
      perspolisProject: {
        ...
        featuredBadge: "★ پروژه شاخص",
        feature1: "منوی دیجیتال تعاملی و سفارش‌گیری آنلاین",
        feature2: "سیستم آنلاین رزرو میز",
        feature3: "پشتیبانی هوشمند چندزبانه",
        previewBtn: "مشاهده پیش‌نمایش وب‌سایت"
      },
      ffstechProject: {
        category: "سیستم‌های هوشمند و زیرساخت دیجیتال",
        title: "پلتفرم جامع و هوشمند FFSTECH",
        desc: "وب‌اپلیکیشن پیشرفته و اختصاصی شرکت FFSTECH مجهز به سیستم‌های هوشمند ساختمان، کنترل دسترسی و زیرساخت دیجیتال.",
        featuredBadge: "★ پروژه شاخص",
      ...
      dentistProject: {
        ...
        desc: "وب‌اپلیکیشن پیشرفته و اختصاصی کلینیک دندانپزشکی مجهز به سیستم نوبت‌دهی آنلاین بیماران، معرفی خدمات درمانی و طراحی چندزبانه.",
        featuredBadge: "★ پروژه شاخص",
        feature1: "سیستم آنلاین نوبت‌دهی بیماران",
        feature2: "معرفی تعاملی خدمات دندانپزشکی",
        feature3: "پورتال اختصاصی بیماران و سرعت بالا",
        previewBtn: "مشاهده پیش‌نمایش وب‌سایت"
      },
      portfolioHero: {
        ...
        titleSuffix: "",
        subtitle: "مجموعه پروژه‌های ما را در حوزه‌های گوناگون بررسی کنید. برای هر ایده و کسب‌وکاری، راهکاری اختصاصی و مدرن طراحی و پیاده‌سازی می‌کنیم.",
        feature1Title: "ایده و راهکار اختصاصی برای هر مدل کسب‌وکار",
        feature1Desc: "هر حوزه کاری نیاز به استراتژی خاص خود دارد؛ ما نیازهای دقیق شما را بررسی و اجرا می‌کنیم.",
        feature2Title: "پروژه‌های متنوع در انواع صنایع",
        feature2Desc: "از فروشگاه‌های آنلاین و خدمات تا سامانه هوش مصنوعی و نرم‌افزارهای ابری.",
        feature3Title: "بهینه‌سازی‌شده برای افزایش فروش و سئو",
        feature3Desc: "سرعت بالا و ظاهر جذابی که رتبه گوگل را ارتقا داده و مشتریان جدید جذب می‌کند.",
        exploreBtn: "بررسی نمونه‌کارها",
        buildBtn: "شروع پروژه اختصاصی",
        ctaTitle: "آیا ایده‌ای برای ساخت وب‌سایت یا اپلیکیشن خود دارید؟",
        ctaSubtitle: "با تیم ما همراه شوید تا وب‌سایت یا اپلیکیشن پرسرعت و مدرن شما را دقیقاً متناسب با اهداف کسب‌وکارتان بسازیم.",
        ctaBtn: "شروع ساخت پروژه"
      },
      ourWork: {
        badge: "جدیدترین نمونه‌کارهای ما",
        titlePrefix: "رشد کسب‌وکار با ",
        titleGradient: "طراحی و توسعه نوآورانه",
        subtitle: "کسب‌وکار خود را با وب‌سایت‌های پرسرعت و طراحی جذاب و کاربرپسند ارتقا دهید.",
        bullet1: "توانایی پشتیبانی از میلیون‌ها کاربر فعال",
        bullet2: "سرعت پاسخگویی فوق‌العاده و زیر ۱ ثانیه",
        bullet3: "سیستم طراحی یکپارچه و مدرن",
        explorePortfolio: "مشاهده تمام نمونه‌کارها",
        startProject: "شروع پروژه"
      },
      brandGrid: {
        badge: "گالری برند و محصولات",
        title: "دقت در طراحی و هویت بصری",
        subtitle: "مشاهده کنید چگونه طراحی دیجیتال را با برندینگ سازمانی یکپارچه می‌کنیم.",
      ...
      testimonials: {
        ...
        reviews: {
          r1: "دیارا وب‌سایت ما را به یک سیستم فوق‌العاده سریع با زمان بارگذاری زیر ۱ ثانیه تبدیل کرد.",
          r2: "سیستم طراحی ارائه‌شده توسط تیم آن‌ها، سرعت توسعه ما را تا ۳ برابر افزایش داد.",
          r3: "اجرای بی‌نقص و بدون حتی یک ثانیه قطعی. پشتیبانی آن‌ها کاملاً عالی و حرفه‌ای بود.",
          r4: "زیبایی بصری فوق‌العاده همراه با سرعت بالا. کاملاً پیشنهادی و عالی!",
          r5: "آن‌ها ابزارهای هوش مصنوعی کاربردی را به صورت کاملاً یکپارچه در وب‌سایت ما قرار دادند.",
          r6: "سیستم طراحی آن‌ها به قدری تمیز است که مدیریت سایت بین تیم‌ها بسیار آسان شده است.",
          r7: "امنیت بالا و طراحی کاربرپسند بدون کوچک‌ترین افت در سرعت تحویل داده شد.",
          r8: "تنها طی دو ماه پس از بازطراحی جدید، فروش و ثبت‌نام مشتریان ما ۴۸٪ افزایش یافت.",
          r9: "دقت مهندسی فوق‌العاده. گزارش‌های دقیق آنلاین، دید کامل عملیاتی را در اختیار ما قرار داد.",
          r10: "همکاری با تیم ارشد آن‌ها مانند داشتن یک تیم هم‌بنیان‌گذار مستقیم در کنار خودمان بود.",
          r11: "سایت ما را بدون هیچ زحمتی برای پاسخگویی به هزاران بازدیدکننده هم‌زمان آماده کردند.",
          r12: "طراحی ظاهر بسیار زیبا و کدنویسی بک‌اند عالی. آن‌ها از تمامی اهداف ما فراتر رفتند.",
          r13: "سرعت بالا حتی در اوج ترافیک سنگین مشتریان به طور کامل حفظ شد.",
          r14: "زیبایی بصری فوق‌العاده. انیمیشن‌ها و جزئیات طراحی هر روز کاربران ما را شگفت‌زده می‌کنند.",
          r15: "وب‌سایت پیچیده ما را زودتر از موعد مقرر و بدون هیچ ایرادی تحویل دادند.",
          r16: "سیستم طراحی آن‌ها فرآیند چندزبانه کردن وب‌سایت ما را بسیار ساده کرد.",
          r17: "داشبوردهای بسیار آسان و هوشمند. کاربران ما عاشق تجربه جدید شده‌اند.",
          r18: "بالاترین سطح حرفه‌ای‌گری و کیفیت کاری. یک شریک واقعی برای کسب‌وکار ما.",
          r19: "ساختار کد فوق‌العاده تمیز و مدرن که توسعه‌های بعدی را بسیار آسان کرده است.",
          r20: "آن‌ها هویت برند و وب‌سایت ما را به یک نمونه برتر در صنعت تبدیل کردند."
        }
      },
      ctaBanner: {
        title: "آماده ساخت وب‌سایت یا اپلیکیشن خود هستید؟",
        subtitle: "همین امروز یک جلسه مشاوره با تیم ارشد طراحی و مهندسی ما تنظیم کنید.",
      ...
      modal: {
        ...
        submittedSub: "با تشکر از ارسال اطلاعات. تیم ما ظرف ۴ ساعت کاری با شما تماس خواهند گرفت.",
        done: "تایید"
      }
    }
  },
