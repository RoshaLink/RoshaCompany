  ...
  sv: {
    translation: {
      ...
      footer: {
        ...
        newsletterSuccess: "Nästan klart! Kolla din inkorg och klicka på länken för att bekräfta din prenumeration.",
      ...
      contactPage: {
        ...
        emailValue: "support@roshalink.com",
        phoneLabel: "Telefon",
        phoneValue: "0724453332",
        ...
        successDesc: "Vår huvudarkitekt går igenom era krav och återkommer med ett svar inom 4 arbetstimmar.",
  ...
  en: {
    translation: {
      ...
      footer: {
        ...
        newsletterSuccess: "Almost done! Check your inbox and click the link to confirm your subscription.",
      ...
      contactPage: {
        ...
        successTitle: "Discovery Request Received!",
        successDesc: "Our lead architect will review your project requirements and email you back within 4 business hours.",
  ...
  fa: {
    translation: {
      ...
      footer: {
        ...
        newsletterSuccess: "تقریباً تمام شد! صندوق ایمیل خود را بررسی کنید و برای تأیید عضویت روی لینک بزنید.",
      ...
      contactPage: {
        ...
        successDesc: "معمار ارشد سیستم ما نیازمندی‌های پروژه شما را بررسی کرده و ظرف ۴ ساعت کاری با شما تماس می‌گیرد.",
  ...
  ar: {
    translation: {
      ...
      footer: {
        ...
        newsletterSuccess: "أوشكت على الانتهاء! تحقّق من بريدك الوارد واضغط على الرابط لتأكيد اشتراكك.",
      ...
      contactPage: {
        ...
        successDesc: "سيقوم كبير المهندسين بمراجعة متطلبات مشروعك والرد عليك خلال 4 ساعات عمل.",
